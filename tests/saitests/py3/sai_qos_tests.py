...
class TunnelDscpToPgMapping(sai_base_test.ThriftInterfaceDataPlane):
    ...
    def _build_testing_pkt(self, active_tor_mac, standby_tor_mac, active_tor_ip, standby_tor_ip, inner_dscp, outer_dscp, dst_ip, packet_size, ecn=1):
...
class PCBBPFCTest(sai_base_test.ThriftInterfaceDataPlane):
    ...
    def build_testing_ipinip_pkt(active_tor_mac, standby_tor_mac, active_tor_ip, standby_tor_ip, inner_dscp, outer_dscp, dst_ip, ecn=1, packet_size=64):
        pkt = simple_tcp_packet(
                pktlen=packet_size,
                eth_dst=standby_tor_mac,
                ip_src='1.1.1.1',
